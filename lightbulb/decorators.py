...
def command(
    ...
    Keyword Args:
        ...
        name_localisations (Mapping[Union[hikari.locales.Locale, :obj:`str`], :obj:`str`]): A set of name localisations for this command. Defaults to an empty dictionary.
        description_localisations (Mapping[Union[hikari.locales.Locale, :obj:`str`], :obj:`str`]): A set of description localisations for this command. Defaults to an empty dictionary.
    ...
    .. versionadded:: 2.2.1
        ``pass_options`` kwarg.
    .. versionadded:: 2.2.5
        ``name_localisations`` and ``description_localisations`` kwargs.
    """
    ...
    **kwargs: t.Any,
    ...
    Keyword Args:
        ...
        autocomplete (Union[:obj:`bool`, AutocompleteCallbackT]): Boolean representing whether the option will use
            ...
            Defaults to ``False``.
        name_localisations (Mapping[Union[hikari.locales.Locale, :obj:`str`], :obj:`str`]): A set of name localisations for this option. Defaults to an empty dictionary.
        description_localisations (Mapping[Union[hikari.locales.Locale, :obj:`str`], :obj:`str`]): A set of description localisations for this option. Defaults to an empty dictionary.
