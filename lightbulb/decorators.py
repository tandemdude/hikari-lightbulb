    ...
    **kwargs: t.Any,
    ...
    Keyword Args:
        ...
        autocomplete (Union[:obj:`bool`, AutocompleteCallbackT]): Boolean representing whether the option will use
            ...
            Defaults to ``False``.
        name_localizations (Mapping[Union[:obj:`hikari.locales.Locale`, :obj:`str`], :obj:`str`]): A set of name localizations for this option. Defaults to an empty dictionary.
        description_localizations (Mapping[Union[:obj:`hikari.locales.Locale`, :obj:`str`], :obj:`str`]): A set of description localizations for this option. Defaults to an empty dictionary.
